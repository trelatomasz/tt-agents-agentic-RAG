...
| **003: Database & Vector Store** | `PENDING` | Database Agent | `001`, `002` | `src/personal_rag/index/postgres.py`, `db/` | [`003-section-database-and-vector-store.md`](003-section-database-and-vector-store.md) |
...
graph TD
    ...
    S001 --> S003["003: Vector Database<br/>(PENDING)"]
