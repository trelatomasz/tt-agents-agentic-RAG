...
| Streaming hides failure semantics | Server-Sent Events emit the same typed failure codes as the HTTP endpoint | `src/gpc_rag/main.py`; `docs/knowledge-evidence/question-evidence.md` Q19 | Stream backpressure and reconnect/resume semantics still need load testing |
